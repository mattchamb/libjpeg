...
ACLOCAL = ${SHELL} /mnt/c/Projects/webassembly_test/jpeg-9b/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emar
AS = as
AUTOCONF = ${SHELL} /mnt/c/Projects/webassembly_test/jpeg-9b/missing autoconf
AUTOHEADER = echo autoheader ignored
AUTOMAKE = ${SHELL} /mnt/c/Projects/webassembly_test/jpeg-9b/missing automake-1.15
AWK = gawk
CC = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emcc
CCDEPMODE = depmode=gcc3
CFLAGS = 
CPP = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
JPEG_LIB_VERSION = 11:0:2
LD = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emcc
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /mnt/c/Projects/webassembly_test/jpeg-9b/missing makeinfo
MANIFEST_TOOL = :
MEMORYMGR = jmemnobs
MKDIR_P = /bin/mkdir -p
NM = /mnt/c/Projects/webassembly_test/emsdk-portable/clang/e1.37.21_64bit/llvm-nm
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
PATH_SEPARATOR = :
RANLIB = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VERSION = 9.2.0
abs_builddir = /mnt/c/Projects/webassembly_test/jpeg-9b
abs_srcdir = /mnt/c/Projects/webassembly_test/jpeg-9b
abs_top_builddir = /mnt/c/Projects/webassembly_test/jpeg-9b
abs_top_srcdir = /mnt/c/Projects/webassembly_test/jpeg-9b
ac_ct_AR = 
ac_ct_CC = /mnt/c/Projects/webassembly_test/emsdk-portable/emscripten/1.37.21/emcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mnt/c/Projects/webassembly_test/jpeg-9b/install-sh
